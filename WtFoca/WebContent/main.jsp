	...
	<div class="container_wrap">
	   ...
	   <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li><img src="images/anuncio2.jpg" class="img-responsive" alt=""/>
	        	<div class="button">
			      <a href="#" class="hvr-shutter-out-horizontal">Clique para concorrer</a>
			    </div>
			</li>
	        <li><img src="images/anuncio1.jpg" class="img-responsive" alt=""/>
	        	<div class="button">
		...
		<div class="box_2">
			<div class="col-md-5 grid_3">
			  ...
			  <div class="col-md-6 grid_4"><a href="single.html">
				  <div class="grid_2">
					<img src="images/Basquete.gif" class="img-responsive" alt=""/>
					<div class="caption1">
						<ul class="list_3">
...
<!-- 				    	<p class="m_3">Guardians of the Galaxy</p>
 -->					</div>
				   ...
				   <div class="grid_2 col_1">
					<img src="images/tirinha1.jpg" class="img-responsive" alt=""/>
					<div class="caption1">
						<ul class="list_3">
				    		<li><i class="icon5"> </i><p>3,548</p></li>
				    	</ul>
			   ...
			   <div class="row_2">
			   	<a href="single.html"><img src="images/slap.gif" class="img-responsive" alt=""/></a>
			   </div>
			</div>
			<div class="col-md-5 content_right">
			 <div class="row_3">
			  <div class="col-md-6 content_right-box"><a href="single.html">
				<div class="grid_2">
				<img src="images/Inferno.jpg" class="img-responsive" alt=""/>
				<div class="caption1">
						<ul class="list_5">
				    		<li><i class="icon5"> </i><p>3,548</p></li>
				    	</ul>
...
<!-- 				    	<p class="m_3">Guardians of the Galaxy</p>
 -->				</div>
			   ...
			   <div class="video">
			      <iframe width="100%" height="" src="https://www.youtube.com/embed/eakAio2o6ek" frameborder="0" allowfullscreen></iframe>
			  </div>
			  <!-- <div class="row_5">
			  	<div class="col-md-6">
					<div class="col_2">
